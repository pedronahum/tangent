...
@pytest.mark.parametrize(
    'fn,arg,expected',
    [pytest.param(fn, arg, expected, id=fn.__name__) for fn, arg, expected in CORRECT_GRADIENTS],
)
...
@pytest.mark.parametrize(
    'fn,exc', [pytest.param(fn, exc, id=fn.__name__) for fn, exc in REJECTIONS]
)
