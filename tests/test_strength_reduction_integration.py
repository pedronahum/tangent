...
class TestStrengthReductionIntegration(unittest.TestCase):
    ...
    def test_square_with_gradient(self):
        ...
        grad_no_sr = tangent.grad(
            f, wrt=(0,), optimized=True, optimizations={'strength_reduction': False}, verbose=0
        )

        # With strength reduction
        grad_with_sr = tangent.grad(
            f, wrt=(0,), optimized=True, optimizations={'strength_reduction': True}, verbose=2
        )
    ...
    def test_all_optimizations_combined(self):
        ...
        grad_f = tangent.grad(
            ...
            wrt=(0,),
            optimized=True,
            optimizations={'dce': True, 'strength_reduction': True, 'cse': True, 'algebraic': True},
            verbose=2,
        )
