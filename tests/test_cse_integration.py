...
class TestCSEOnOptimizedGradients(unittest.TestCase):
    ...
    def test_with_basic_optimization(self):
        ...
        grad_f = tangent.grad(f, wrt=(0,), optimized=True, optimizations={'dce': False}, verbose=0)
    ...
    def test_with_dce_enabled(self):
        ...
        # With DCE
        grad_f = tangent.grad(f, wrt=(0,), optimized=True, optimizations={'dce': True}, verbose=0)
