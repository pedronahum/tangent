...
- [`benchmarks/building_simulation_compare.py`](https://github.com/pedronahum/tangent/blob/master/benchmarks/building_simulation_compare.py) - Run all benchmarks
